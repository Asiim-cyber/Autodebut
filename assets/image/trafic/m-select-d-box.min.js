    ...
    MSelectDBox.prototype = {
        ...
        "_globalStyles": (function() {
            var styles = {
                ...
                ".m-select-d-box": {
                    position: "absolute", display: "block", width: "250px", padding: '8px', height: "auto", "box-shadow": "0 10px 20px -5px rgba(0, 0, 0, 0.4)", "background-color": "#FFF", "border-radius": "3px", border: "1px solid #e6e6e6"
                },
                ...
                ".m-select-d-box__list-item": {
                    position: "relative", padding: "10px", "background-color": "none", color: "black", display: "block", "line-height": "100%", cursor: "pointer", "font-size": "14px"
                },
        ...
        "_initElements": function() {
            ...
            var searchInputContainer = $(
                ...
                '<input class="m-select-d-box__search-input" placeholder="tapez ici...' +
